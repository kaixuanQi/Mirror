...
public class Binder {
    ...
    public static String[] getStringArray(JSONObject object, String key) {
    ...
    public interface JsonSerializable {
        void writeToJSONObject(JSONObject object, int flags) throws JSONException;
    }
    ...
    public static IBinder peekBinder(Object object) {
        ...
        synchronized (BinderProxy.localBinders) {
            for (Map.Entry<IBinder, Object> entry : BinderProxy.localBinders.entrySet()) {
    ...
    public static class ClassHolder {
        private final Map<String, BinderMethod> methods;
            ...
            public void writeToParcel(Parcel reply, Object object, Type type, Class rawType) throws Exception {
                if (rawType.isInterface()) {
                    ...
                    if (object == null) {
                        ...
                        ((JsonSerializable) object).writeToJSONObject(jsonObject, 0);
            ...
            public Object readFromParcel(Parcel data, Type type, Class rawType) throws Exception {
                if (rawType == int.class) {
                    ...
                    if (json == null) {
                        ...
                        return rawType.getConstructor(JSONObject.class).newInstance(object);
                    }
                } else if (Parcelable.class.isAssignableFrom(rawType)) {
