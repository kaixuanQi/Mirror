...
public abstract class CommonViewModel extends ContextViewModel {
    ...
    final void attachRequestViewModel(RequestViewModel viewModel) {
        if (this.requestViewModel == null) {
            ...
            ViewModelManager.dispatchCreateViewModel(this);
            onViewModelCreated();
        }
    }
    ...
    void attach(CommonActivity activity) {
        ...
        ViewModelManager.dispatchAttachActivity(this, activity);
        onAttach(activity);
    }
    ...
    void attach(CommonFragment fragment) {
        ...
        ViewModelManager.dispatchAttachActivity(this, requireActivity());
        onAttach(fragment.requireActivity());
    }

    @Override
    void detach() {
        ViewModelManager.dispatchDetachActivity(this, requireActivity());
        onDetach();
        super.detach();
    }
    ...
    protected void onCleared() {
        ViewModelManager.dispatchClear(this);
        super.onCleared();
    }
