...
import com.zero.support.common.widget.recycler.tools.CellList;
...
public class CellAdapter extends BaseAdapter implements CellList.ListCallback {
    ...
    public CellAdapter(CommonViewModel viewModel) {
    ...
    public <T extends CommonViewModel> T getViewModel() {
        return (T) viewModel;
    }
