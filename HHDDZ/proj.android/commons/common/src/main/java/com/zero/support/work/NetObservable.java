...
public class NetObservable extends SerialObservable<Integer> {
    ...
    public NetObservable(Context context) {
        ...
        setValue(getNetWorkState());
    }

    public static int getNetWorkState() {
        //得到连接管理器对象
        ConnectivityManager connectivityManager = (ConnectivityManager) AppGlobal.getApplication()
    ...
    @Override
    public synchronized void remove(Observer<Integer> observer) {
