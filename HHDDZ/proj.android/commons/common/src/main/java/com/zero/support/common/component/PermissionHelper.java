...
public class PermissionHelper {
    ...
    public static boolean hasPermissionPermanentlyDenied(@NonNull CommonActivity host, @NonNull PermissionModel model, String[] permissions) {
        for (String permission : permissions) {
            if (!host.shouldShowRequestPermissionRationale(model, permission)) {
                return true;
            }
        }
        return false;
    ...
    public static void notifyAlreadyHasPermissions(@NonNull RequestViewModel viewModel, @NonNull String[] perms) {
